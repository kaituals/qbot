...
class DenyJoinCommand extends Command_1.Command {
    constructor() {
        super({
            trigger: 'denyjoin',
    ...
    async run(ctx) {
        ...
        try {
            ...
            ctx.reply({ embeds: [await (0, locale_1.getSuccessfulDenyJoinRequestEmbed)(robloxUser)] });
            (0, handleLogging_1.logAction)('Deny Join Request', ctx.user, ctx.args['reason'], robloxUser);
        }
        catch (err) {
            console.log(err);
...
exports.default = DenyJoinCommand;
